<?php if (!class_exists('jobcareer7353street_options_fields')) {

    class jobcareer7353street_options_fields {
	 ...
	 */
	public function jobcareer7353street_cs_fields($cs_setting_options) {
