...
<div class="main-search inner-search">
    ...
    <form class="search-area" class="top-view-srch-form" data-ajaxurl="<?php echo esc_js(admin_url('admin-ajax.php')); ?>">
        ...
        $cs_show_profession_filter = '';
        ?>

        <?php do_action('jobhunt_professions_candidate_search_resume', $cs_show_profession_filter); ?>
        ...
        <div class="col-lg-2 col-md-2">
            <div class="search-btn">
                <input type="submit" class="cs-bgcolor" style="font-size: 13px !important;" value="<?php esc_html_e("Search Professionals", "jobhunt"); ?>">
            </div>
        </div>
    </form>
</div>
