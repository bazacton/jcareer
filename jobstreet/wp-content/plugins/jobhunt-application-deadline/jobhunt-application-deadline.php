...
class Job_Hunt_Application_Deadline {
    ...
    public function __construct() {
        ...
        // Define constants
        define('JOBHUNT_APPLICATION_DEADLINE_PLUGIN_VERSION', '3.2');
    ...
    public function application_deadline_field_frontend($job_id) {
        ...
        //$date = date('d-m-Y');
		$date = date('d-m-Y', strtotime("+60 days"));
		$date = apply_filters('jobhunt_application_deadline_default_date', $date);
        if ($job_id != '') {
     ...
     * @return array
     */
    public function exclude_expired_jobs_from_listing($args = array(), $job_sort_by = '') {
