<?php if (!class_exists('jobcareer7533ntdesk_options_fields')) {

    class jobcareer7533ntdesk_options_fields {
	 ...
	 */
	public function jobcareer7533ntdesk_cs_fields($cs_setting_options) {
