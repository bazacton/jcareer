                ...
                <div class="cs-media">
                    <figure>
                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img
                                    alt="<?php the_title(); ?>" src="<?php echo esc_url($thumbnail); ?>"></a>
                    </figure>
                </div>
                <div class="blog-text">
                    <div class="cs-inner-bolg">
                        <div class="thumb-post">
                            ...
                            <div class="cs-text">
                                <p>
                                    <a href="<?php echo get_author_posts_url($author_id); ?>"><?php echo the_author_meta('display_name' , $author_id); ?></a><span
                                            class="post-date"><a
                                                href="<?php echo get_month_link(get_the_time('Y') , get_the_time('m')); ?>"><?php echo get_the_date('F j, Y'); ?></a></span></span>
                                </p>
                            </div>
                        </div>
                        <div class="cs-post-title">
                            ...
                            <?php if ($cs_blog_description == 'yes') { ?>
                                <p> <?php echo jobcareer_get_excerpt($cs_blog_excerpt , 'true' , ''); ?></p> <?php } ?>
