<?php if (!class_exists('jobcareer9851indjob_options_fields')) {

    class jobcareer9851indjob_options_fields {
	 ...
	 */
	public function jobcareer9851indjob_cs_fields($cs_setting_options) {
