       ...
       // $jobcareer_postObject = get_post_meta( $jobcareer_shop_id, 'cs_full_data', true );
        ...
        if (!empty($jobcareer_xmlObject) && is_array($jobcareer_xmlObject) && count($jobcareer_xmlObject) > 1) {
                                ...
                                <a href="<?php echo esc_url( $image_url ); ?>" data-rel="prettyPhoto" data-title="">
                                    <figure>
                                        <div class="page-featured-image">
                                            <img class="img-thumbnail cs-page-thumbnail" title="featured-image" alt="featured-image" data-src="" src="<?php echo esc_url( $image_url ); ?>">
                                        </div>
                                    </figure>
                                </a>
                                <?php
            ...
            foreach ( $jobcareer_xmlObject->column_container as $column_container ) {
                ...
                ?>
                <!-- Page Section -->
                <div <?php echo jobcareer_special_char($jobcareer_section_css_id); ?> class="page-section <?php echo sanitize_html_class( $parallax_class ); ?>" <?php echo jobcareer_special_char($parallax_data_type); ?>  <?php echo jobcareer_special_char($section_style_element); ?> >
                    <?php
