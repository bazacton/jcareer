                            ...
                            for ($j = 1; $j <= $a; $j ++) {
                                ...
                                // Job Post
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        $shortcode_response = apply_filters('jobhunt_post_job_professions_element_fields', $cs_counter_jobs_search, $_POST);
                                        if( $shortcode_response != '' && $shortcode_response != '0'){
                                            $shortcode .= $shortcode_response;
                                        }
                                        $shortcode_response = apply_filters('jobhunt_job_search_element_fields_saving_backend', $cs_counter_jobs_search, $_POST);
                                        if( $shortcode_response != '' && $shortcode_response != '0'){
                                            $shortcode .= $shortcode_response;
                                        }
