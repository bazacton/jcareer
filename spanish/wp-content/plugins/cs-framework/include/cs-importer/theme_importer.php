...
if (!function_exists('cs_demo_importer')) {
    ...
    function cs_demo_importer() {
        ...
        do_action('jobcareer_theme_check');
        ?>
                    ...
                    <div class="importer-steps-containers-wrapper importer-text row">
                        <div class="step-1-container">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h3><?php _e('Server php.ini Requirements', 'cs_frame'); ?></h3>
                                <ul class="importer-requirement">
                                    <?php if (!empty($server_requirements['requirements'])) : ?>
                                        <?php foreach ($server_requirements['requirements'] as $requirement) : ?>
                                            <li>
                                                <div class="pull-left">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h3><?php _e('Extensions & Permissions Requirements', 'cs_frame'); ?></h3>
                                <ul class="importer-requirement">
                                    <?php if (!empty($server_requirements['extentions'])) : ?>
                                        <?php foreach ($server_requirements['extentions'] as $requirement) : ?>
                                            <li>
                                                <div class="pull-left">
                                                    <div class="text-holder">
                                                        <span class="text-bold text-uppercase"><?php echo $requirement['title']; ?></span>
                                                    ...
                                                    <div class="text-holder">
                                                        ...
                                                        <span class="details">
                                                            ...
                                                            if (!empty($requirement['new_version'])) {
                                                                echo 'There is a new version ' . $requirement['new_version'] . ' available.';
                                                            }
                                                            ?>
                                                        </span>
                                                    </div>
                        ...
                        <div class="step-2-container validate-purchase-key hidden">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                if ($envato_purchase_code_verification) {
                                    if (isset($envato_purchase_code_verification['item_id']) && $theme_id == $envato_purchase_code_verification['item_id'] && $envato_purchase_code_verification['last_verification_time'] + 30 * 24 * 60 * 60 > time()) {
                                        $verify_code = false;
                                    }
                                }
                                ?>
                                <?php if ($verify_code) : ?>
                                    <p><?php _e('Purchase code verification is required to Import Demo Data, you can verify it', 'jobcareer'); ?> <a href="<?php echo admin_url('admin.php?page=cs_settings'); ?>"><?php _e('here', 'jobcareer'); ?></a>.</p>
                                    <form role="form">
                                        <div class="control-group">
                                            <label style="display: none;" for="item-purchase-code"><?php _e('Item Purchase Code', 'cs_frame'); ?></label>
                                            ...
                                            <label style="display: none;"  for="envato-email-address"><?php _e('Envato Provided Email Address', 'cs_frame'); ?></label>
                        ...
                        <div class="step-3-container hidden">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="jobhunt-demos demo-data-type col-lg-6 col-md-6 col-sm-12 active" data-demo_item="jobhunt-demo-item">
                                    <div class="title-holder">
                                        <span class="title-large"><?php _e('JOBHUNT DEMOS', 'cs_frame'); ?></span>
                                    </div>
                                </div>
                                <div class="elementor-demos demo-data-type col-lg-6 col-md-6 col-sm-12" data-demo_item="elementor-demo-item">
                                    <div class="title-holder">
                                        <span class="title-large"><?php _e('ELEMENTOR DEMOS', 'cs_frame'); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <ul class="demos-list importer-list row">
                                        <?php if (!empty($demo_data_structure)) : $counter = 0; ?>
                                            <?php foreach ($demo_data_structure as $demo_item) : $counter ++; ?>
                                                <?php $demo_class = (strpos($demo_item['slug'], 'elementor') !== false)? 'elementor-demo-item hide' : 'jobhunt-demo-item'; ?>
                                                <li class="<?php echo $demo_class; ?> demo-data-item-wrapper col-lg-3 col-md-3 col-sm-6 col-xs-12" data-name="<?php echo $demo_item['slug']; ?>">
                                                    <div class="radiobox">
                    ...
                    function change_step_callback(elem) {
                        ...
                        if (current_step == 1) {
                            ...
                            if (is_purchase_code_verified || is_purchase_code_already_verified) {
                                ...
                                alert("<?php echo __('Please Verify Your Purchasecode From Jobcareer Settings First to Install Demo Data.', 'cs_frame'); ?>");
                                change_step = false;
                            }
...
function cs_import_demo_data_callback() {
    ...
    if ('import_data' == $action_type) {
        ...
        if ($envato_purchase_code_verification) {
            ...
            if (
                    $item_purchase_code == isset($envato_purchase_code_verification['item_purchase_code']) && $envato_purchase_code_verification['item_purchase_code'] && $envato_purchase_code_verification['last_verification_time'] + 30 * 24 * 60 * 60 > time()
            ) {
                $success = true;
            } else {
