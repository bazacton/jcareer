<?php if (!class_exists('jobcareer7369bakery_options_fields')) {

    class jobcareer7369bakery_options_fields {
	 ...
	 */
	public function jobcareer7369bakery_cs_fields($cs_setting_options) {
