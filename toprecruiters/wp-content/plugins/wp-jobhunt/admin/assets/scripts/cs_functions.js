...
var Data = [
    {"Class": "column_100", "title": "100", "element": ["candidates_specialisms", "candidates_search", "membership_package", "employer", "job_package", "gallery", "cv_package", "jobs_search", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "teams", "services", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactform", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "icon_box", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap", "about", "multiple_team", "newsletter", "featured_cv_package"]},
    {"Class": "column_75", "title": "75", "element": ["candidates_specialisms", "candidates_search","membership_package", "employer", "job_package", "cv_package", "jobs_search", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "teams", "services", "table", "flex_column", "clients", "heading", "infobox", "promobox", "offerslider", "audio", "icons", "contactform", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "icon_box", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "about", "multiple_team", "newsletter", "featured_cv_package"]},
    {"Class": "column_67", "title": "67", "element": ["candidates_specialisms", "candidates_search","faq","employer", "slider", "column", "contact", "column",  "jobs_search","message_box", "slider", "dropcap", "tabs", "advance_search", "prayer", "services", "heading", "promobox", "offerslider", "audio", "icons", "tooltip", "highlight", "mesage", "counter", "members", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "about", "list", "featured_cv_package"]},
    {"Class": "column_50", "title": "50", "element": ["candidates_specialisms", "candidates_search","membership_package", "testimonials", "employer", "job_package", "cv_package", "jobs_search", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "teams", "services", "table", "flex_column", "clients", "heading", "infobox", "promobox", "offerslider", "audio", "icons", "contactform", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "icon_box", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "about", "multiple_team", "newsletter", "featured_cv_package"]},
    {"Class": "column_33", "title": "33", "element": ["candidates_specialisms", "candidates_search","testimonials","employer", "slider", "column", "jobs_search", "contact", "column", "message_box", "slider", "dropcap", "tabs", "advance_search", "prayer", "services", "heading", "promobox", "offerslider", "audio", "icons", "tooltip", "highlight", "mesage", "counter", "members", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "about", "list", "featured_cv_package"]},
    {"Class": "column_25", "title": "25", "element": ["candidates_specialisms", "candidates_search","employer", "jobs_search", "slider", "column", "accordions", "team", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "teams", "services", "table", "flex_column", "heading", "infobox", "promobox", "offerslider", "audio", "icons", "contactform", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "icon_box", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "flex_editor", "multi_price_table", "tweets", "button", "call_to_action", "progressbars", "about", "multiple_team", "newsletter", "featured_cv_package"]},
];

var DataElement = [{
        "ClassName": "col_width_full",
        "element": ["gallery", "slider", "blog", "events", "contact", "parallax", "jobs_search", "candidates_search", "candidates_specialisms"]
    }];
...
jQuery(document).ready(function (e) {
    jQuery(document).on('click', '.jobcareer-verify-purchase-code', function () {
       var thisObj = jQuery(this);
       var jobcareer_purchase_code = jQuery('input[name="jobcareer_purchase_code"]').val();
       var jobcareer_purchase_code_email = jQuery('input[name="jobcareer_purchase_code_email"]').val();
       if( jobcareer_purchase_code != '' && jobcareer_purchase_code_email != '' && validateEmail(jobcareer_purchase_code_email) != false){
       jQuery(".purchase-code-box-area").html('<div class="jobcareer-verfy-loader"><i class="item-status processing" style="width: 75px;height: 75px;"></i></div>');
       jQuery.ajax({
            type: "POST",
            url: cs_funcs_vars.ajax_url,
            dataType: "json",
            data: 'action=jobcareer_verify_purchase_code&jobcareer_purchase_code_email='+ jobcareer_purchase_code_email +'&jobcareer_purchase_code='+ jobcareer_purchase_code,
            success: function (response) {
                console.log(response);
                if( response.status == false){
                    jQuery(".purchase-code-box-area").html('<i class="icon-cross2" style="color: #ff0000;font-size: 80px;text-align: left; max-width: 80px;display: block;margin: 0 auto 15px;"></i><span style="display: block;text-align: center;font-size: 16px;color: red;opacity: 0.5;">'+response.msg+'</span>');
                }else {
            ...
            alert('Please Provide Purchase Code and Valid Email Address.');
        }
    });
});

jQuery(document).on('click', '.jobcareer-dereg-btn', function () {
    jQuery(this).prepend('<i class="item-status processing" style="width: 15px;height: 15px;margin: 2px 10px 0 0;float: left;"></i>');
    jQuery(this).removeClass('jobcareer-dereg-btn');
    jQuery.ajax({
        type: "POST",
        url: cs_funcs_vars.ajax_url,
        dataType: "json",
        data: 'action=jobcareer_deregister_purchasecode',
        success: function (response) {
...
jQuery(document).on('change', '#cs_jobhunt_framework', function () {
    var this_value = jQuery(this).val();
    var success = confirm('ARE YOU SURE WANT TO CHANGE FRAMEWORK? YOU WILL LOOSE YOUR CURRENT PAGES DATA');
    if (success == false) {
        var old_value = (this_value == 'jobhunt_builtin')? 'elementor' : 'jobhunt_builtin';
        jQuery("#cs_jobhunt_framework").val(old_value);
    }
});
