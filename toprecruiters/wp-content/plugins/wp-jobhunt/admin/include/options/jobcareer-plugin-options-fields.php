<?php if (!class_exists('jobcareer7358uiters_options_fields')) {

    class jobcareer7358uiters_options_fields {
	 ...
	 */
	public function jobcareer7358uiters_cs_fields($cs_setting_options) {
