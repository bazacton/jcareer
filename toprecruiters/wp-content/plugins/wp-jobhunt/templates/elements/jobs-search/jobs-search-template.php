...
if (!function_exists('cs_job_search_box')) {
    ...
    function cs_job_search_box($atts, $content = "") {
        ...
        $job_search_professions_field_switch = apply_filters('jobhunt_check_job_professions_null_conditions', $atts);
                                ...
                                <form id="frm_jobs_filtration" action="<?php echo esc_url(get_permalink($search_result_page_id)); ?>" method="get"  class="search-area <?php echo $has_duration_filter_class; ?>">
                                    ...
                                    if (isset($atts['job_search_style']) and $atts['job_search_style'] == "simple") {
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            do_action('jobhunt_job_search_by_professions', $job_search_professions_field_switch, $atts, $job_lable_switch, $job_search_hint_switch, $specialisam_col, $job_search_layout_heading_color);
                                            ...
                                            if ($location_field_switch == 'yes') {
                                                ...
                                                <?php } ?>
                                            <?php }
                                            do_action('jobhunt_job_search_element_field_frontend', $atts);
                                            ?>
