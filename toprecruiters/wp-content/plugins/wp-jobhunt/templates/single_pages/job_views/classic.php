                                    ...
                                    <div class="employer-company">
                                        ...
                                        <div class="cs-text">
                                            ...
                                            <ul class="detail-list">
                                                ...
                                                if ($job_address != '') echo '<li><address> ' . $job_address . '</address></li>'; }?>
                                                <?php
                                                if ($cs_employee_web != '') {
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="more-jobs">
                                                            <?php if ($display_shortlist_button == 'yes') { ?>
                                                                ...
                                                                <?php } else {
                                                                    $list_job_ids = isset($list_job_id) ? $list_job_id : '';
                                                                    ?>
                                                                    <li><a class="cs-add-wishlist" href="javascript:void(0)"  id="<?php echo 'addjobs_to_wishlist' . intval($list_job_ids); ?>" onclick="show_alert_msg('<?php echo esc_html__("Become a candidate then try again.", "jobhunt"); ?>')" ><i class="icon-heart-o"></i><?php esc_html_e('Shortlist', 'jobhunt'); ?></a></li>
                                                                <?php } ?>
                                                            <?php } ?>
                            ...
                            <div class="modal-body">
                                <div class="cs-profile-contact-detail cs-contact-modal" data-adminurl="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" data-cap="recaptcha8">
                                    ...
                                    <form id="ajaxcontactemployer" action="#" method="post" enctype="multipart/form-data">
                                        ...
                                        $employer_post_ID = '';
                                        if(isset($employer_post->ID) && $employer_post->ID != ''){
                                          $employer_post_ID = $employer_post->ID;
                                        }
                                        ?>

                                        <div class="submit-btn profile-contact-btn" data-employerid="<?php echo esc_html($employer_post_ID); ?>">
