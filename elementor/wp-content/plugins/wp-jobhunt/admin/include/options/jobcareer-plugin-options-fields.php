<?php if (!class_exists('jobcareer9713mentor_options_fields')) {

    class jobcareer9713mentor_options_fields {
	 ...
	 */
	public function jobcareer9713mentor_cs_fields($cs_setting_options) {
