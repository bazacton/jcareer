...
class Jobhunt_CallToAction_Frontend
{
    ...
    public function render($settings)
    {
        ...
        $cs_call_to_action_img = isset($cs_call_to_action_img['url']) ? $cs_call_to_action_img['url'] : '';
        ...
        $html .= '<p>' . $cs_call_action_contents . '</p>';
        $html .= '</div>';
        ...
        echo $col_div_start . '<div class="leftaction">' . $html . '</div>' . $col_div_end;
