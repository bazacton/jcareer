...
class Jobhunt_Testimonials_Frontend
{
    ...
    public function render($settings)
    {
        ...
        if (isset($testimonial_style) and $testimonial_style == 'classic') {
            ...
            $html .= '<div class="testimonial-advance' . $has_bg_class . '">'
                ...
                . $this->render_tesitimonial_items_array($testimonial_item)
                . '</ul>'
                . '</div>';
    ...
    public function render_tesitimonial_item($atts)
    {
        ...
        $figure = '';
        $html = '';
        $testimonial_img_user = isset($testimonial_img_user['url']) ? $testimonial_img_user['url'] : '';
        ...
        if (isset($testimonial_style) and $testimonial_style == 'simple') {
            ...
            $html .= '<span' . $cs_test_text_color . '>' . $testimonial_text . '</span>';
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="testimonial-inner">
                            <div class="testimonial-home box box-modern">
                                <div class="question-mark"> <span' . $cs_test_text_color . '>' . $testimonial_text . '</span>
            ...
            $html .= '
                    <li>
                        ...
                        <div class="question-mark"> 
                            <span' . $cs_test_text_color . '>' . $testimonial_text . '</span>
                            <div class="cs-text">
                                <div class="cs-author-info">
                                    <h5' . $cs_test_author_color . '>' . $testimonial_author . '</h5>
            ...
            $html .= '
                    <li>
                            <div class="question-mark">
                                    ...
                                    <p' . $cs_test_text_color . '>' . $testimonial_text . '</span>
                            </div>
                    </li>';
            ...
            $html .= '<p' . $cs_test_text_color . '>' . $testimonial_text . '</p>';
            $html .= '</div>';
            $html .= '</li>';
        } elseif (isset($testimonial_style) and $testimonial_style == 'aviation') {
            $html .= '
