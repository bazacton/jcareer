...
jQuery(document).on('click', '.demo-data-type', function (e) {
    jQuery('.demo-data-type').removeClass('active');
    jQuery(this).addClass('active');
    var demo_item = jQuery(this).data('demo_item');
    jQuery('.jobhunt-demo-item').addClass('hide');
    jQuery('.elementor-demo-item').addClass('hide');
    jQuery('.'+demo_item).removeClass('hide');
});
