    ...
    class cs_employer_templates {
        ...
        public function cs_employer_menu($uid, $cs_pkg_array) {
                ...
                <?php } if (isset($cs_emploayer_dashboard_vew) && $cs_emploayer_dashboard_vew == 'fancy' || $cs_emploayer_dashboard_vew == 'fancy_full') { ?>
                    <aside class="section-sidebar col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <ul class="account-menu">
                            ...
                            <?php } ?>
                            <?php
                            $job_post_title = esc_html__('Post a New Job', 'jobhunt');
                            $job_post_title = apply_filters('jobhunt_post_job_title', $job_post_title);
                            ?>
                            <li id="employer_left_postjobs_link" <?php if ((isset($_REQUEST['profile_tab']) && $_REQUEST['profile_tab'] == 'postjobs')) echo 'class="active"'; ?>>
                                <a id="employer_postjobs_click_link_id" href="javascript:void(0);" onclick='cs_dashboard_tab_load("postjobs", "employer", "<?php echo esc_js(admin_url('admin-ajax.php')); ?>", "<?php echo absint($uid); ?>", "");' ><i class="icon-plus-square"></i><?php esc_html_e($job_post_title, 'jobhunt'); ?></a>
                            </li>
                            <?php
            ...
            public function cs_employer_post_job($cs_elem = false) {
                ...
                if ($cs_post_job == false && $cs_job_id != '') {
                    do_action('jobhunt_save_professions_in_jobs', isset($_POST['cs_job_profession']) ? $_POST['cs_job_profession'] : '', $cs_job_id);
                }
                ...
                if ($cs_job_id <> '' && isset($_POST['cs_pkg_trans']) && $_POST['cs_pkg_trans'] == 1 && $cs_job_emplyr == $current_user->ID) {
                    ...
                    if (!empty($cs_job_types)) {
                        wp_set_post_terms($cs_job_id, array(), 'job_type', FALSE);
                        foreach ($cs_job_types as $cs_job_type) {
                            $cs_job_type = (int) $cs_job_type;
                            wp_set_post_terms($cs_job_id, array($cs_job_type), 'job_type', true);
                        }
                    }
                    ...
                    <div class="scetion-title">
                        <h3>
                            ...
                            if (isset($_GET['job_id']) && $_GET['job_id'] != '') {
                                ...
                                echo esc_html__('Post Job', 'jobhunt');
                            }
                            ?>
                        </h3>
                    </div>
                                    ...
                                    if ($cs_free_jobs_switch != 'on') {
                                        ...
                                        <div class="input-info">
                                            <div class="row">
                                                ...
                                                <?php do_action('jobhunt_job_fields_before_title_frontend', $cs_job_id); ?>    
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php
                                                    if ($cs_job_id > 0) {
                                                        $settings = array('tinymce' => true, 'teeny' => true, 'media_buttons' => false, 'textarea_name' => 'cs_job_desc', 'editor_class' => 'customwp_editor', 'editor_height' => 300);
                                                    } else {
                                                        $settings = array('media_buttons' => false, 'textarea_name' => 'cs_job_desc', 'editor_class' => 'customwp_editor', 'editor_height' => 300);
                                                    }
                                                    $cs_job_desc = (isset($cs_job_desc)) ? ($cs_job_desc) : '';
                                                    wp_editor($cs_job_desc, 'cs_job_desc_editor', $settings);
                                                    ?>
                                                </div>
                                                <?php if ($cs_job_id == 0 || $cs_job_id == '') { ?>
                                                    <script type="text/javascript">
                                                        jQuery(document).ready(function () {
                                                            tinymce.execCommand('mceRemoveEditor', false, 'cs_job_desc_editor');
                                                            tinymce.execCommand('mceAddEditor', false, 'cs_job_desc_editor');
                                                            //tinymce.execCommand('mceRemoveEditor', false, 'cs_job_desc_editor');
                                                        });
                                                    </script>
                                                <?php } ?>
                                                ...
                                                <?php do_action('jobhunt_profile_view_professions', $cs_job_id, true); ?>
                                                ...
                                                do_action('jobhunt_post_job_fields_frontend', $cs_job_id, $_REQUEST);
                        ...
                        if (is_array($cs_fav_resumes) && sizeof($cs_fav_resumes) > 0 && !empty($cs_fav_resumes)) {
                            ...
                            <ul class="resumes-list">
                                ...
                                foreach ($cs_fav_resumes as $key => $cs_fav) {
                                    ...
                                    $resume_list_class = apply_filters('jobhunt_resume_list_class', '', $cs_fav); //custom
                                    ?>
                                    <li class="<?php echo esc_html($resume_list_class); ?>">
                                        <?php
                                        ...
                                        <div class="cs-text">
                                            <?php if ($cs_candidate_switch == 'on') { ?>
                                                <?php if ($cs_emp_funs->is_employer() && $cs_emp_funs->is_cv_pkg_subs()) { ?>
                                                    <h3><a href="<?php echo esc_url(get_author_posts_url($cs_fav->ID)) ?>">
                                                        ...
                                                        <?php do_action('jobhunt_applicant_title_after', $cs_fav); ?>
                                                    </h3>
                                                <?php } else { ?>
                                                    <h3>
                                                        <?php
                                                ...
                                                <h3>
                                                    ...
                                                    $user_job_applied_status = get_user_meta($cs_fav->ID, 'cs-jobs-status', true);
                                                    if ($user_job_applied_status = true) {
                                                        echo isset($cs_fav->first_name) && $cs_fav->first_name != '' ? $cs_fav->first_name : $cs_fav->display_name;
                                                    } else {
                                                        echo $cs_fav->display_name;
                                                    }
                                                    ?>
                                            ...
                                            <div class="cs-uploaded candidate-detail">
                                                <?php
                                                $application_statuses = cs_update_job_application_statuses();
                                                $application_status = get_user_meta($cs_fav->ID, 'cs_job_application_status_' . $user_job_id, true);
                                                $application_status = $application_status == '' ? 'in-progress' : $application_status;
                                                ?>
                                                <div class="cs-downlod-sec application-status">
                                                    <a class="label"><?php esc_html_e('Application Status', 'jobhunt') ?></a>
                                                    <ul>
                                                        <?php foreach ($application_statuses as $key => $status) { ?>
                                                            <li <?php echo $application_status == $key ? 'class="active"' : ''; ?>><a href="javascript:void(0);" onclick="cs_update_application_status(this, '<?php echo $cs_fav->ID; ?>', '<?php echo $user_job_id; ?>', '<?php echo $key; ?>')"><?php echo esc_html($status); ?></a></li>
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                                                <div class="cs-downlod-sec">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php if ($cs_candidate_switch == 'on') { ?>
                                                            ...
                                                            <li><a href="<?php echo esc_url(get_author_posts_url($cs_fav->ID)) ?>"><?php esc_html_e('View Profile', 'jobhunt') ?></a></li>
                                                        <?php } ?>
                                                        <?php do_action('jobhunt_application_action_button', $user_job_id, $cs_fav->ID); ?>
                                                    </ul>
                                                </div>
                                                ...
                                                <?php do_action('jobhunt_application_action_button_after', $user_job_id, $cs_fav->ID); ?>
                                                <!-- end popup -->
                                                <!-- send message popup -->
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div id="ajaxcontact-response-<?php echo absint($cs_fav->ID) ?>" class="error-msg" style="display:none;"></div>
