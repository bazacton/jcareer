<?php if (!class_exists('jobcareer9154extjob_options_fields')) {

    class jobcareer9154extjob_options_fields {
	 ...
	 */
	public function jobcareer9154extjob_cs_fields($cs_setting_options) {
