...
if (!function_exists('cs_jobs_listing')) {
    ...
    function cs_jobs_listing($atts, $content = "") {
        ...
        $qrystr .= apply_filters('jobhunt_profession_job_search_query_string_callback', $profession);
        ...
        $profession = isset( $_GET['professions'] )? $_GET['professions'] : '';
        $filter_arr2[] = apply_filters('jobhunt_profession_job_search_query_callback', $profession);
        
        $filtered_query = apply_filters('jobhunt_listing_query_filter_frontend', array(), $atts);
        
        $filter_arr2[] = !empty( $filtered_query )? $filtered_query : '';
        ...
        $jobs_postqry = '';
        $jobs_meta_query    = apply_filters('jobhunt_listing_meta_query_filter_frontend', array(), $atts);
        //if ($cs_job_map == 'yes') {
        if ($job_title != '') {
        ...
        if ($column_class != '') {
            ...
            <div class="cs-jobs-container">
                <?php
                $args = apply_filters('job_hunt_jobs_listing_query_frontend', $args, $a, $atts);
