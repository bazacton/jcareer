...
if (!class_exists('wp_jobhunt')) {
    ...
    class wp_jobhunt
    {
        ...
        public function __construct()
        {
            ...
            add_action('jobcareer_load_folder' , array($this , 'jobcareer_load_folder_callback'));
        ...
        public function jobcareer_load_folder_callback($folder_path)
        {
            foreach (glob(wp_jobhunt::plugin_dir() . '/' . $folder_path . '/' . '*.php') as $filename) {
        ...
        public function includes()
        {
            ...
            require_once 'admin/classes/jobhunt-authentication.php';
            // Mobile API
            require_once 'api/app_tabs_api.php';
            require_once 'api/app_configuration_api.php';
            require_once 'api/jobs_api.php';
            require_once 'api/users_api.php';
            require_once 'api/employers_api.php';
            ...
            require_once 'classes/email-templates/class-job-application-status-update.php';
        ...
        public function cs_single_template($single_template)
        {
            ...
            if (isset($_GET['check']) && $_GET['check'] == 'heartbeat') {
                echo json_encode('jobhunt');
                exit;
            }
            if ($cs_jobhunt_framework == 'elementor' && (get_page_template_slug() == '' || get_page_template_slug() == 'page.php' || is_front_page())) {
                if (is_singular('page')) {
                    $single_template = get_template_directory(__FILE__) . '/elementor-page.php';
                }
            }
        ...
        public function cs_defaultfiles_plugin_enqueue()
        {
            ...
            if (!is_admin()) {
                wp_enqueue_style('jobcareer_iconmoon_css' , plugins_url('/assets/icomoon/css/iconmoon.css' , __FILE__));
            ...
            wp_enqueue_style('cs_llmaps-style' , plugins_url('/assets/css/llmaps-style.css' , __FILE__));
            //wp_enqueue_style('cs_jobhunt_rich_editor-style-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
            //wp_enqueue_style('cs_jobhunt_rich_editor-style', plugins_url('/assets/css/richtext.min.css', __FILE__));
            //wp_enqueue_script('cs_jobhunt_rich_editor', plugins_url('/assets/scripts/jquery.richtext.js', __FILE__), '', '', true);
            ...
            wp_enqueue_script('cs_leafletjs-script' , plugins_url('/assets/scripts/leaflet.js' , __FILE__) , '' , '' , false);
            wp_enqueue_script('cs_llmaps-script' , plugins_url('/assets/scripts/llmaps-config.js' , __FILE__) , '' , '' , false);
            wp_enqueue_style('cs_leafletjs-style' , plugins_url('/assets/css/leaflet.css' , __FILE__));
            ...
            wp_enqueue_script('jobcareer_modernizr_min_js' , plugins_url('/assets/scripts/modernizr.min.js' , __FILE__) , '' , '' , '');
            wp_enqueue_script('jobcareer_browser_detect_js' , plugins_url('/assets/scripts/browser-detect.js' , __FILE__) , '' , '' , '');
            wp_enqueue_script('cs_slick_js' , plugins_url('/assets/scripts/slick.js' , __FILE__) , '' , '' , true);
            wp_enqueue_script('jobcareer_jquery_sticky_js' , plugins_url('/assets/scripts/jquery.sticky.js' , __FILE__) , '' , '' , true); //?
            wp_enqueue_script('cs_swiper_min' , plugins_url('/assets/scripts/swiper.min.js' , __FILE__) , '' , '' , true); //?
            wp_enqueue_script('cs_jobhunt_functions_js' , plugins_url('/assets/scripts/jobhunt_functions.js' , __FILE__) , '' , '' , false);
            wp_enqueue_script('jobhunt-google-platform' , 'https://accounts.google.com/gsi/client');
            wp_enqueue_script('jobhunt-google-decoder' , 'https://unpkg.com/jwt-decode/build/jwt-decode.js');
            /*echo '<div id="g_id_onload"
                data-client_id="884989793352-7cb5kia89ilb8f1n6m7367k2ag47crjn.apps.googleusercontent.com"
                data-callback="onSuccessGooglelogin">
           </div><div class="g_id_signin" data-type="standard"></div>';*/
