        ...
        public function cs_transactions_area() {
            ...
            if ($custom_query->have_posts()) {
                ...
                while ($custom_query->have_posts()) : $custom_query->the_post();
                    ...
                    if ($cs_trans_type == 'profile_check') {
                        $cs_trans_id = get_post_meta(get_the_id(), "cs_trans_id", true);
                        $cs_trans_pkg_title = esc_html__('Background Check', 'jobhunt');
                        $cs_trans_amount = get_post_meta(get_the_id(), "cs_trans_amount", true);
                    }
