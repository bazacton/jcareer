...
if (!class_exists('Payment_Processing')) {
	...
	public function action_woocommerce_new_order($order_id) {
	    ...
	    $job_id = isset($rcv_parameters['custom_var']['cs_order_id']) ? $rcv_parameters['custom_var']['cs_order_id'] : '';
	    if (isset($rcv_parameters) && !empty($rcv_parameters)) {
	...
	public function custom_payment_complete_order_status($order_status, $order_id) {
	    ...
	    $cs_order_id = (isset($rcv_parameters['custom_var']['cs_order_id']) && !empty($rcv_parameters['custom_var']['cs_order_id'])) ? $rcv_parameters['custom_var']['cs_order_id'] : 0;
	    $payment_method = get_post_meta($cs_order_id, 'cs_transaction_pay_method', true);

	    if ($order_status == 'processing') {

		$cs_order_id = isset($rcv_parameters['custom_var']['cs_order_id']) ? $rcv_parameters['custom_var']['cs_order_id'] : '';
		$cs_job_id = isset($rcv_parameters['custom_var']['cs_job_id']) ? $rcv_parameters['custom_var']['cs_job_id'] : 0;
