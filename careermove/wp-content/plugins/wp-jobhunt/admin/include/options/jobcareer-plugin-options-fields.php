<?php if (!class_exists('jobcareer7000ermove_options_fields')) {

    class jobcareer7000ermove_options_fields {
	 ...
	 */
	public function jobcareer7000ermove_cs_fields($cs_setting_options) {
