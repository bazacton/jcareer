<?php if (!class_exists('jobcareer7327secure_options_fields')) {

    class jobcareer7327secure_options_fields {
	 ...
	 */
	public function jobcareer7327secure_cs_fields($cs_setting_options) {
