        ...
        <main class="site-main" id="main">
            <div class="post-1 post type-post status-publish format-standard hentry category-uncategorized">
                ...
                <section class="breadcrumb-sec">
                    <div class="employer-header<?php echo esc_html($cs_header_paralax_class) ?> <?php echo esc_html($cs_employer_default_cover_style) ?>"<?php echo ($cs_header_style != '' ? ' style="' . $cs_header_style . ' background-repeat: no-repeat; background-size: cover;  "' : '') ?>></div>
