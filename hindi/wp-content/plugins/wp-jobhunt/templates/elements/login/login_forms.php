			...
			<?php } ?>
				...
				if (is_user_logged_in()) {
					...
					//echo apply_filters('social_login_login_google', '<li><div class="g-signin2" data-onsuccess="onSignIn" data-theme="dark"></div></li>');
                                        ...
                                        if( $signup == 'yes'){
                                            echo apply_filters('social_login_login_google', '<li><a  href="javascript:void(0);" id="googlesignup'.$google_rand_id.'" data-client_id="884989793352-7cb5kia89ilb8f1n6m7367k2ag47crjn.apps.googleusercontent.com" data-callback="onSuccessGooglelogin" rel="nofollow" title="' . esc_html__('google-sinin', 'jobhunt') . '" data-original-title="google-plus" class=" gplus g_id_signin"><span class="social-mess-top gplus-social-login aaaaaaa" style="display:none">' . esc_html__('Please set API key', 'jobhunt') . '</span><i class="icon-google"></i>Sign In With Google</a></li>');
                                        } else {
                                            echo apply_filters('social_login_login_google', '<li><a  href="javascript:void(0);" id="googlesignin'.$google_rand_id.'" data-client_id="884989793352-7cb5kia89ilb8f1n6m7367k2ag47crjn.apps.googleusercontent.com" data-callback="onSuccessGooglelogin" rel="nofollow" title="' . esc_html__('google-sinin', 'jobhunt') . '" data-original-title="google-plus" class=" gplus g_id_signin"><span class="social-mess-top gplus-social-login" style="display:none">' . esc_html__('Please set API key', 'jobhunt') . '</span><i class="icon-google"></i>Sign In With Google</a></li>');
                                        }
                                ...
                                <div id="g_id_onload" style="display:none;"
                                    data-client_id="<?php echo $cs_google_client_id; ?>"
...
function cs_twitter_auth_callback() {
	...
	$twitter_oath_callback = home_url('social-login=twitter-callback');
