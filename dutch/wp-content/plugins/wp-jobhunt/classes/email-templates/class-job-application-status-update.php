...
/**
 * File Type: Send Mail Job Application Status Updated Successfully Templates
 */
if ( ! class_exists('job_application_status_update_template') ) {

    class job_application_status_update_template {
        ...
        public function __construct($args = '') {
            $this->email_template_type = 'Job Application Status Update for Candidate';
            $this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Job Application Status Notfication for Candidate</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="260" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td>[CANDIDATE_NAME], Your application status has changed successfully.</td></tr><tr><td style="padding: 10px 0 0 0;">Application Status: [APPLICATION_STATUS]</td></tr><tr><td style="padding: 10px 0 0 0;">Job Title: [JOB_TITLE]</td></tr><tr><td style="padding: 10px 0 0 0;">Job url: [JOB_URL]</td></tr></table></td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2020</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
            ...
            $this->email_template_variables = array(
                ...
                array(
                    ...
                    'display_text' => __('Application Status', 'jobhunt'),
                    'value_callback' => array( $this, 'get_application_status' ),
                ),
            );
            $this->template_group = 'Candidate';
            $this->email_template_index = 'job-application-status-candidate-notification-template';
            ...
            add_action('job_application_status_notification', array( $this, 'job_application_status_notification_callback' ));
        }

        public function job_application_status_notification_callback( $arg = array() ) {
            ...
            if ( isset($template['email_notification']) && $template['email_notification'] == 1 ) {
                ...
                $subject     = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : __("Application Status has been Updated Successfully!", "jobhunt");
        ...
        function get_application_status() {
            $application_status = cs_update_job_application_statuses( $this->status );
        ...
        public function add_email_template() {
            ...
            $email_templates[$this->template_group][$this->email_template_index] = array(
                ...
                'description' => __('This template is used sending email when job application status updated successfully', 'jobhunt'),
                'jh_email_type' => 'html',
            );
    ...
    return new job_application_status_update_template();
}
