...
if (!function_exists('cs_ajax_candidate_profile')) {
    ...
    function cs_ajax_candidate_profile($uid = '') {
        ...
        if ($uid <> '') {
            ...
            $cs_candidate_dashboard_vew = (isset($cs_plugin_options['cs_candidate_dashboard_view']) && $cs_plugin_options['cs_candidate_dashboard_view'] != '') ? $cs_plugin_options['cs_candidate_dashboard_view'] : 'default';
            ...
            <form id="cs_candidate" name="cs_candidate"  method="POST" enctype="multipart/form-data" >
                ...
                <div class="dashboard-content-holder">
                    <section class="cs-profile-info">
                        ...
                        ?>
                        <?php
                        $display_candidate_cover_image = 'yes';
                        $display_candidate_cover_image = apply_filters('jobhunt_candidate_cover_image', $display_candidate_cover_image);
                        if (!$custom_addon_active && $display_candidate_cover_image == 'yes') {
                        ...
                        <div class="input-info">
                            <div class="row">
                                ...
                                <?php if (!$custom_addon_active) { ?>
                                    ...
                                    $display_candidate_minimum_salary_field = 'yes';
                                    $display_candidate_minimum_salary_field = apply_filters('jobhunt_candidate_minimum_salary_field', $display_candidate_minimum_salary_field);
                                    
                                    if (!$nicolas_active && $display_candidate_minimum_salary_field == 'yes') {
                                        ?>
                                ...
                                <?php } ?>
                                <?php do_action('jobhunt_profile_view_professions', $uid, false); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    $settings = array( 'media_buttons' => false, 'textarea_name' => 'candidate_content', 'editor_class' => 'customwp_editor', 'editor_height' => 250); 
                                    wp_editor($cs_description, 'cs_candidate_content_editor', $settings);
                                    ?>
                                    <script type="text/javascript">
                                        jQuery(document).ready(function () {
                                            tinymce.execCommand('mceRemoveEditor', false, 'cs_candidate_content_editor');
                                            tinymce.execCommand('mceAddEditor', false, 'cs_candidate_content_editor');
                                        });
                                    </script>
                                </div>
                            </div>
                            ...
                            <div class="input-info">
                                <div class="row">
                                    <div class="social-media-info">
                                        ...
                                        <?php do_action('jobhunt_candidate_social_networks', $uid); ?>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    while ($custom_query->have_posts()) : $custom_query->the_post();
                                        ...
                                        $cs_trans_package_title = get_post_meta(get_the_id(), "cs_transaction_package_title", true);
                                        if($cs_trans_package_title == ''){
                                            $cs_trans_package_title = isset( $cs_memberhsip_packages_options[$cs_trans_package]['memberhsip_pkg_title'] )? $cs_memberhsip_packages_options[$cs_trans_package]['memberhsip_pkg_title'] : $cs_trans_package_title;
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $cs_trans_package_title; ?></td>
    ...
    function cs_ajax_candidate_appliedjobs($uid = '') {
        ...
        if ($uid <> '') {
            ...
            <section class="cs-favorite-jobs">
                ...
                <div class="field-holder">
                    <ul class="top-heading-list">
                        <li class="heading"><span><?php esc_html_e('Job Title', 'jobhunt'); ?></span></li>
                        <li class="status"><span><?php esc_html_e('Status', 'jobhunt'); ?></span></li>
                        <li class="date"><span><?php esc_html_e('Date Applied', 'jobhunt'); ?></span></li>
                    </ul>
                        ...
                        <ul class="feature-jobs">
                            ...
                            if ($custom_query->have_posts()) :
                                while ($custom_query->have_posts()) : $custom_query->the_post();
                                    ...
                                    $application_status = get_user_meta($user, 'cs_job_application_status_'.$post->ID, true);
                                    $application_status = $application_status == '' ? 'in-progress' : $application_status;
                                    $application_status_label = cs_update_job_application_statuses( $application_status );
                                    ?>
                                    <li class="holder-<?php
                                    echo intval($post->ID);
                                    ...
                                    ?>">
                                        ...
                                        <div class="application-status-inner">
                                            <span class="application-status <?php echo $application_status; ?>"><?php echo $application_status_label; ?></span>
                                        </div>
                                        <div class="company-date-option">
                                            <span><?php
                                                $finded = in_multiarray($post->ID, $cs_jobapplied_array, 'post_id');
                                                if ($finded != '')
                                                    if (isset($cs_jobapplied_array[$finded[0]]['date_time']) && $cs_jobapplied_array[$finded[0]]['date_time'] != '') {
