<?php if (!class_exists('jobcareer9013_dutch_options_fields')) {

    class jobcareer9013_dutch_options_fields {
	 ...
	 */
	public function jobcareer9013_dutch_cs_fields($cs_setting_options) {
