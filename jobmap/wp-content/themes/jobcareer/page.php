        ...
        if (isset($count)) {
            ...
            if (isset($jobcareer_xmlObject->column_container)) {
                ...
                foreach ($jobcareer_xmlObject->column_container as $column_container) {
                    ...
                    ?>
                    <!-- Page Section -->
                    <div <?php echo jobcareer_special_char($cs_section_css_id); ?> class="page-section<?php
                    echo jobcareer_special_char($custom_bacground_option_class);
