<?php
class Jobhunt_Employers_Frontend{
    ...
    public function render($settings) {
        ...
        $a = shortcode_atts(
            ...
            'cs_employer_cols' => '12', // 2columns, 3columns, 4columns
            'cs_employer_title' => '', // simplelist or detaillist
                ), $settings
        );
        extract(shortcode_atts($a, $settings));
        ...
        <div class="cs-content-holder">
            ...
            if ( $a['cs_employer_searchbox'] == 'yes' ) {
                ...
                include('employers/employer-searchbox.php');
            }
            if ( $a['cs_employer_searchbox'] == 'yes' ) {
...
//             employer views
            ...
            if ( $a['cs_employer_view'] == 'simple' ) {
                include( 'employers/views/cs_simple.php' );
            } elseif ( $a['cs_employer_view'] == 'alphabatic' ) {
                include( 'employers/views/cs_alphabatic.php' );
            } elseif ( $a['cs_employer_view'] == 'grid' ) {
                include( 'employers/views/cs_grid.php' );
            } elseif ( $a['cs_employer_view'] == 'list' ) {
                include( 'employers/views/cs_list.php' );
            } elseif ( $a['cs_employer_view'] == 'box' ) {
                include( 'employers/views/cs_box.php' );
            } elseif ( $a['cs_employer_view'] == 'fancy' ) {
                include( 'employers/views/cs_fancy.php' );
            } elseif ( $a['cs_employer_view'] == 'modern' ) {
                include( 'employers/views/cs_modern.php' );
            }
