<?php if (!class_exists('jobcareer8628bstack_options_fields')) {

    class jobcareer8628bstack_options_fields {
	 ...
	 */
	public function jobcareer8628bstack_cs_fields($cs_setting_options) {
