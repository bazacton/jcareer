<?php if (!class_exists('jobcareer7045up_com_options_fields')) {

    class jobcareer7045up_com_options_fields {
	 ...
	 */
	public function jobcareer7045up_com_cs_fields($cs_setting_options) {
