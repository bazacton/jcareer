...
if (!function_exists('jobcareer_custom_style_theme_options')) {
    ...
    function jobcareer_custom_style_theme_options() {
        ...
        $importent_label = ($cs_jobhunt_framework == 'jobhunt_builtin')? '!important' : '';
        ?>
        /*!
        * Theme Color File */
        <?php
        if (isset($cs_container_default_width) && $cs_container_default_width != '') {
            ...
            .container {width:<?php echo jobcareer_special_char($cs_container_default_width); ?>px <?php echo $importent_label; ?>}
        <?php }
        ?>
        .cs-color,
        ...
        <?php if (isset($cs_theme_color) || $cs_theme_color != '') { ?>
            color:<?php echo jobcareer_special_char($cs_theme_color); ?> <?php echo $importent_label; ?>;
        <?php } ?>
        }
        /*!
        * Theme Background Color */
        ...
        <?php if (isset($cs_theme_color) || $cs_theme_color != '') { ?>
            background-color:<?php echo jobcareer_special_char($cs_theme_color); ?> <?php echo $importent_label; ?>;
        <?php } ?>
        }
        .cookiealert{
        <?php if (isset($cs_theme_color) || $cs_theme_color != '') { ?>
            background:<?php echo jobcareer_special_char($cs_theme_color); ?> <?php echo $importent_label; ?>;
        <?php } ?>
        }
        /*!
        * Theme Border Color */
        ...
        {
        <?php if (isset($cs_theme_color) || $cs_theme_color != '') { ?>
            border-color:<?php echo jobcareer_special_char($cs_theme_color); ?> <?php echo $importent_label; ?>;
        <?php } ?>
        }

        .wp-jobhunt .pricetable-holder.classic{
        <?php if (isset($cs_theme_color) || $cs_theme_color != '') { ?>
            border-top-color:<?php echo jobcareer_special_char($cs_theme_color); ?> <?php echo $importent_label; ?>;
        <?php } ?>
        }
        ...
        if (isset($jobcareer_options['cs_default_header']) and $jobcareer_options['cs_default_header'] == 'no_header') {
            if ($main_header_border_color <> '') {
                ...
                #header {
                border-bottom: 1px solid <?php echo jobcareer_special_char($cs_header_border_color); ?> <?php echo $importent_label; ?>;
                }
                <?php
            }
        }
	...
	font-style: normal;
        ...
        if ((isset($cs_content_size) && $cs_content_size != '') || (isset($cs_content_spc) && $cs_content_spc != '') || (isset($cs_content_textr) && $cs_content_textr != '') || (isset($cs_text_color) && $cs_text_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_content_size) && $cs_content_size != '') {
                    echo 'font-size: ' . $cs_content_size . '<?php echo $importent_label; ?>;';
                }
                if (isset($cs_content_spc) && $cs_content_spc != '') {
                    echo esc_html($cs_content_spc != '' ? 'letter-spacing: ' . $cs_content_spc . 'px '. $importent_label .';' : '');
                }
                ...
                if (isset($cs_text_color) && $cs_text_color != '') {
                    echo esc_html($cs_text_color != '' ? 'color: ' . $cs_text_color . ' '. $importent_label .';' : '');
                }
            } else {
                ...
                if (isset($cs_content_textr) && $cs_content_textr != '') {
                    echo esc_html($cs_content_textr != '' ? 'text-transform: ' . $cs_content_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_text_color) && $cs_text_color != '') {
                    echo esc_html($cs_text_color != '' ? 'color: ' . $cs_text_color . ' '. $importent_label .';' : '');
                }
        ...
        if ((isset($cs_mainmenu_size) && $cs_mainmenu_size != '') || (isset($cs_mainmenu_spc) && $cs_mainmenu_spc != '') || (isset($cs_mainmenu_textr) && $cs_mainmenu_textr != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_mainmenu_spc) && $cs_mainmenu_spc != '') {
                    echo esc_html($cs_mainmenu_spc != '' ? 'letter-spacing: ' . $cs_mainmenu_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_mainmenu_textr) && $cs_mainmenu_textr != '') {
                    echo esc_html($cs_mainmenu_textr != '' ? 'text-transform: ' . $cs_mainmenu_textr . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_1_size) && $cs_heading_1_size != '') || (isset($cs_heading_1_spc) && $cs_heading_1_spc != '') || (isset($cs_heading_1_textr) && $cs_heading_1_textr != '') || (isset($cs_heading_h1_color) && $cs_heading_h1_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_1_spc) && $cs_heading_1_spc != '') {
                    echo esc_html($cs_heading_1_spc != '' ? 'letter-spacing: ' . $cs_heading_1_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_1_textr) && $cs_heading_1_textr != '') {
                    echo esc_html($cs_heading_1_textr != '' ? 'text-transform: ' . $cs_heading_1_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h1_color) && $cs_heading_h1_color != '') {
                    echo esc_html($cs_heading_h1_color != '' ? 'color: ' . $cs_heading_h1_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_2_size) && $cs_heading_2_size != '') || (isset($cs_heading_2_spc) && $cs_heading_2_spc != '') || (isset($cs_heading_2_textr) && $cs_heading_2_textr != '') || (isset($cs_heading_h2_color) && $cs_heading_h2_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_2_spc) && $cs_heading_2_spc != '') {
                    echo esc_html($cs_heading_2_spc != '' ? 'letter-spacing: ' . $cs_heading_2_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_2_textr) && $cs_heading_2_textr != '') {
                    echo esc_html($cs_heading_2_textr != '' ? 'text-transform: ' . $cs_heading_2_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h2_color) && $cs_heading_h2_color != '') {
                    echo esc_html($cs_heading_h2_color != '' ? 'color: ' . $cs_heading_h2_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_3_size) && $cs_heading_3_size != '') || (isset($cs_heading_3_spc) && $cs_heading_3_spc != '') || (isset($cs_heading_3_textr) && $cs_heading_3_textr != '') || (isset($cs_heading_h3_color) && $cs_heading_h3_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_3_spc) && $cs_heading_3_spc != '') {
                    echo esc_html($cs_heading_3_spc != '' ? 'letter-spacing: ' . $cs_heading_3_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_3_textr) && $cs_heading_3_textr != '') {
                    echo esc_html($cs_heading_3_textr != '' ? 'text-transform: ' . $cs_heading_3_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h3_color) && $cs_heading_h3_color != '') {
                    echo esc_html($cs_heading_h3_color != '' ? 'color: ' . $cs_heading_h3_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_4_size) && $cs_heading_4_size != '') || (isset($cs_heading_4_spc) && $cs_heading_4_spc != '') || (isset($cs_heading_4_textr) && $cs_heading_4_textr != '') || (isset($cs_heading_h4_color) && $cs_heading_h4_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_4_spc) && $cs_heading_4_spc != '') {
                    echo esc_html($cs_heading_4_spc != '' ? 'letter-spacing: ' . $cs_heading_4_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_4_textr) && $cs_heading_4_textr != '') {
                    echo esc_html($cs_heading_4_textr != '' ? 'text-transform: ' . $cs_heading_4_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h4_color) && $cs_heading_h4_color != '') {
                    echo esc_html($cs_heading_h4_color != '' ? 'color: ' . $cs_heading_h4_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_5_size) && $cs_heading_5_size != '') || (isset($cs_heading_5_spc) && $cs_heading_5_spc != '') || (isset($cs_heading_5_textr) && $cs_heading_5_textr != '') || (isset($cs_heading_h5_color) && $cs_heading_h5_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_5_spc) && $cs_heading_5_spc != '') {
                    echo esc_html($cs_heading_5_spc != '' ? 'letter-spacing: ' . $cs_heading_5_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_5_textr) && $cs_heading_5_textr != '') {
                    echo esc_html($cs_heading_5_textr != '' ? 'text-transform: ' . $cs_heading_5_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h5_color) && $cs_heading_h5_color != '') {
                    echo esc_html($cs_heading_h5_color != '' ? 'color: ' . $cs_heading_h5_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_heading_6_size) && $cs_heading_6_size != '') || (isset($cs_heading_6_spc) && $cs_heading_6_spc != '') || (isset($cs_heading_6_textr) && $cs_heading_6_textr != '') || (isset($cs_heading_h6_color) && $cs_heading_h6_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_heading_6_spc) && $cs_heading_6_spc != '') {
                    echo esc_html($cs_heading_6_spc != '' ? 'letter-spacing: ' . $cs_heading_6_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_heading_6_textr) && $cs_heading_6_textr != '') {
                    echo esc_html($cs_heading_6_textr != '' ? 'text-transform: ' . $cs_heading_6_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_heading_h6_color) && $cs_heading_h6_color != '') {
                    echo esc_html($cs_heading_h6_color != '' ? 'color: ' . $cs_heading_h6_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_section_title_size) && $cs_section_title_size != '') || (isset($cs_section_title_spc) && $cs_section_title_spc != '') || (isset($cs_section_title_textr) && $cs_section_title_textr != '') || (isset($cs_section_title_color) && $cs_section_title_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_section_title_spc) && $cs_section_title_spc != '') {
                    echo esc_html($cs_section_title_spc != '' ? 'letter-spacing: ' . $cs_section_title_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_section_title_textr) && $cs_section_title_textr != '') {
                    echo esc_html($cs_section_title_textr != '' ? 'text-transform: ' . $cs_section_title_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_section_title_color) && $cs_section_title_color != '') {
                    echo esc_html($cs_section_title_color != '' ? 'color: ' . $cs_section_title_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_post_title_size) && $cs_post_title_size != '') || (isset($cs_post_title_spc) && $cs_post_title_spc != '') || (isset($cs_post_title_textr) && $cs_post_title_textr != '') || (isset($cs_post_title_color) && $cs_post_title_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_post_title_spc) && $cs_post_title_spc != '') {
                    echo esc_html($cs_post_title_spc != '' ? 'letter-spacing: ' . $cs_post_title_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_post_title_textr) && $cs_post_title_textr != '') {
                    echo esc_html($cs_post_title_textr != '' ? 'text-transform: ' . $cs_post_title_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_post_title_color) && $cs_post_title_color != '') {
                    echo esc_html($cs_post_title_color != '' ? 'color: ' . $cs_post_title_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_page_title_size) && $cs_page_title_size != '') || (isset($cs_page_title_spc) && $cs_page_title_spc != '') || (isset($cs_page_title_textr) && $cs_page_title_textr != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_page_title_spc) && $cs_page_title_spc != '') {
                    echo esc_html($cs_page_title_spc != '' ? 'letter-spacing: ' . $cs_page_title_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_page_title_textr) && $cs_page_title_textr != '') {
                    echo esc_html($cs_page_title_textr != '' ? 'text-transform: ' . $cs_page_title_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_page_title_color) && $cs_page_title_color != '') {
                    echo esc_html($cs_page_title_color != '' ? 'color: ' . $cs_page_title_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if ((isset($cs_widget_heading_size) && $cs_widget_heading_size != '') || (isset($cs_widget_heading_spc) && $cs_widget_heading_spc != '') || (isset($cs_widget_title_color) && $cs_widget_title_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_widget_heading_spc) && $cs_widget_heading_spc != '') {
                    echo esc_html($cs_widget_heading_spc != '' ? 'letter-spacing: ' . $cs_widget_heading_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_widget_heading_textr) && $cs_widget_heading_textr != '') {
                    echo esc_html($cs_widget_heading_textr != '' ? 'text-transform: ' . $cs_widget_heading_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_widget_title_color) && $cs_widget_title_color != '') {
                    echo esc_html($cs_widget_title_color != '' ? 'color: ' . $cs_widget_title_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        <?php if (isset($cs_ft_widget_title_color) && $cs_ft_widget_title_color <> "") { ?>
            #footer .widget-title h5{ <?php echo esc_html($cs_ft_widget_title_color != '' ? 'color: ' . $cs_ft_widget_title_color . ' '. $importent_label .';' : ''); ?>}
        ...
        if ((isset($cs_ft_widget_heading_size) && $cs_ft_widget_heading_size != '') || (isset($cs_ft_widget_heading_spc) && $cs_ft_widget_heading_spc != '') || (isset($cs_ft_widget_heading_textr) && $cs_ft_widget_heading_textr != '') || (isset($cs_ft_widget_title_color) && $cs_ft_widget_title_color != '')) {
            ...
            if ($custom_font == true) {
                ...
                if (isset($cs_ft_widget_heading_spc) && $cs_ft_widget_heading_spc != '') {
                    echo esc_html($cs_ft_widget_heading_spc != '' ? 'letter-spacing: ' . $cs_ft_widget_heading_spc . 'px '. $importent_label .';' : '');
                }
                if (isset($cs_ft_widget_heading_textr) && $cs_ft_widget_heading_textr != '') {
                    echo esc_html($cs_ft_widget_heading_textr != '' ? 'text-transform: ' . $cs_ft_widget_heading_textr . ' '. $importent_label .';' : '');
                }
                if (isset($cs_ft_widget_title_color) && $cs_ft_widget_title_color != '') {
                    echo esc_html($cs_ft_widget_title_color != '' ? 'color: ' . $cs_ft_widget_title_color . ' '. $importent_label .';' : '');
                }
            } else {
        ...
        if (isset($cs_menu_heading_color) && $cs_menu_heading_color != '') {
            ?>
            .dropdown-menu h6 a{color:<?php echo jobcareer_special_char($cs_menu_heading_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_topstrip_bgcolor) && $cs_topstrip_bgcolor != '') {
            ?>
            .top-bar,#lang_sel ul ul {background-color:<?php echo jobcareer_special_char($cs_topstrip_bgcolor); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_topstrip_bgcolor) && $cs_topstrip_bgcolor != '') {
            ?>
        ...
        if (isset($cs_topstrip_text_color) && $cs_topstrip_text_color != '') {
            ?>
            .top-bar p{color:<?php echo jobcareer_special_char($cs_topstrip_text_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_topstrip_link_color) && $cs_topstrip_link_color != '') {
            ?>
            .top-bar a,.top-bar i{color:<?php echo jobcareer_special_char($cs_topstrip_link_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_header_bgcolor) && $cs_header_bgcolor != '') {
            ?>
            .logo-section,#header,.main-head{background:<?php echo jobcareer_special_char($cs_header_bgcolor); ?> <?php echo $importent_label; ?>; 
        ...
        if (isset($cs_main_header_padding) && $cs_main_header_padding != '') {
            ?>
            .main-head{
            padding:<?php echo jobcareer_special_char($cs_main_header_padding); ?>px <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_nav_bgcolor) && $cs_nav_bgcolor != '') {
            ?>
            .main-navbar,#main-header .btn-style1,.wrapper:before {background:<?php echo jobcareer_special_char($cs_nav_bgcolor); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_nav_bgcolor) && $cs_nav_bgcolor != '') {
            ?>
            .navigation, #header.dark-header {background:<?php echo jobcareer_special_char($cs_nav_bgcolor); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_submenu_bgcolor) && $cs_submenu_bgcolor != '') {
            ?>
            .dropdown-menu { background-color:<?php echo jobcareer_special_char($cs_submenu_bgcolor); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_submenu_color) && $cs_submenu_color != '') {
            ?>
            .navigation > ul > li > ul li > a {color:<?php echo jobcareer_special_char($cs_submenu_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_submenu_hover_color) && $cs_submenu_hover_color != '') {
            ?>
            .navigation > ul ul li > a:hover {color:<?php echo jobcareer_special_char($cs_submenu_hover_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_menu_active_color) && $cs_menu_active_color != '') {
            ...
            color:<?php //echo jobcareer_special_char($cs_menu_active_color);       ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_menu_active_color) && $cs_menu_active_color != '') {
            ?>
            .sub-dropdown:before {border-bottom:8px solid <?php echo jobcareer_special_char($cs_menu_active_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_menu_active_color) && $cs_menu_active_color != '') {
            ?>
            .navigation > ul > li.parentIcon:hover > a:before { background-color:<?php echo jobcareer_special_char($cs_menu_active_color); ?> <?php echo $importent_label; ?>; }
            <?php
        }
        if (isset($cs_menu_color) && $cs_menu_color != '') {
            ?>
            .navigation > ul > li > a, #nav-icon2 i, #header.cs-transparent-header .search-bar i, #header.cs-transparent-header .join-us > a, header#header.cs-transparent-header .login > a, header#header.cs-transparent-header .wish-list a i { color:<?php echo jobcareer_special_char($cs_menu_color); ?> <?php echo $importent_label; ?>; }
            <?php
        }
        if (isset($cs_menu_color) && $cs_menu_color != '') {
            ?>
            #header.cs-transparent-header .navicon, #header.cs-transparent-header .navicon::before, #header.cs-transparent-header .navicon::after{ background:<?php echo jobcareer_special_char($cs_menu_color); ?> <?php echo $importent_label; ?>; }
            <?php
        }
        if (isset($cs_menu_color) && $cs_menu_color != '') {
            ?>
            #header.cs-transparent-header .join-us > a, header#header.cs-transparent-header .login > a { border-color:<?php echo jobcareer_special_char($cs_menu_color); ?> <?php echo $importent_label; ?>; background:none <?php echo $importent_label; ?>; }
            <?php
        }
        if (isset($cs_menu_active_color) && $cs_menu_active_color != '') {
            ?>
            .cs-user,.cs-user-login { border-color:<?php echo jobcareer_special_char($cs_menu_active_color); ?> <?php echo $importent_label; ?>; }
            <?php
        }
        if (isset($cs_widget_color) && $cs_widget_color != '') {
            ?>
            .page-sidebar .widget-title h3, .page-sidebar .widget-title h4, .page-sidebar .widget-title h5, .page-sidebar .widget-title h6{
            color:<?php echo jobcareer_special_char($cs_widget_color); ?> <?php echo $importent_label; ?>;
            }<?php
        }
        if (isset($cs_widget_color) && $cs_widget_color != '') {
            ?>
        ...
        if (isset($cs_footer_top_border_color) && $cs_footer_top_border_color != '') {
            ?>
            .cs-copyright-area, #footer .cs-footer.fancy-footer .footer-top, .cs-footer.modern-footer .footer-top {border-top:1px solid <?php echo jobcareer_special_char($cs_footer_top_border_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_footer_top_border_color) && $cs_footer_top_border_color != '') {
            ?>
            .cs-footer.modern-footer .cs-copyright .back-to-top a:before,
            .cs-footer.modern-footer .cs-copyright .back-to-top a:after {background: <?php echo jobcareer_special_char($cs_footer_top_border_color); ?> <?php echo $importent_label; ?>;}
        <?php } ?>
        ...
        */
        <?php if (isset($cs_topstr_bg_color) && $cs_topstr_bg_color != '') { ?>
            #header .top-bar {
            background-color:<?php echo jobcareer_special_char($cs_topstr_bg_color); ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_topstr_text_color) && $cs_topstr_text_color != '') {
            ?>
            #header .top-bar {
            color:<?php echo jobcareer_special_char($cs_topstr_text_color); ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_topstr_link_color) && $cs_topstr_link_color != '') {
            ?>
            #header .top-bar a {
            color:<?php echo jobcareer_special_char($cs_topstr_link_color); ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_topstr_linkhover_color) && $cs_topstr_linkhover_color != '') {
            ...
            color:<?php echo jobcareer_special_char($cs_topstr_linkhover_color); ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_topstr_iconhover_color) && $cs_topstr_iconhover_color != '') {
            ...
            color:<?php echo jobcareer_special_char($cs_topstr_iconhover_color); ?> <?php echo $importent_label; ?>;
            }
        <?php }if (isset($cs_topstr_icon_color) && $cs_topstr_icon_color != '') { ?>
            #header .top-bar .social-media a i {
            color:<?php echo jobcareer_special_char($cs_topstr_icon_color); ?> <?php echo $importent_label; ?>;
            }
            <?php
        }
        /**
        ...
        $cs_bg_footer_color = 'background-color:rgba(' . $footer_bg_color[0] . ', ' . $footer_bg_color[1] . ', ' . $footer_bg_color[2] . ', 0.95) '. $importent_label .';';
        ...
        if (isset($cs_footer_text_color) && $cs_footer_text_color != '') {
            ?>
            footer#footer p, footer#footer span, footer#footer .textwidget{color:<?php echo jobcareer_special_char($cs_footer_text_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_footerbg_color) && $cs_footerbg_color != '') {
            ...
            if ($cs_footer_style != 'aviation-footer') {
                ...
                border-radius: 0px <?php echo $importent_label; ?>;
                background-color: transparent <?php echo $importent_label; ?>;
                border: none <?php echo $importent_label; ?>; }
                .footer-top, #footer .footer-v3 .cs-copyright {
                background-color:<?php echo jobcareer_special_char($cs_footerbg_color); ?> <?php echo $importent_label; ?>;
        ...
        if (isset($cs_footerbg_image) && $cs_footerbg_image != '') {
            ?>
            footer#footer {
            background-image:url("<?php echo jobcareer_special_char($cs_footerbg_image); ?>") <?php echo $importent_label; ?>;
            }
            <?php
        }
        if (isset($cs_copyright_text_color) && $cs_copyright_text_color != '') {
            ?>
            .footer-links,.footer-links a{color:<?php echo jobcareer_special_char($cs_copyright_text_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_copyright_bg_color) && $cs_copyright_bg_color != '') {
            ?>.footer-btm {background-color:<?php echo jobcareer_special_char($cs_copyright_bg_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
        if (isset($cs_copyright_text_color) && $cs_copyright_text_color != '') {
            ?>
            #footer  .copyrights{
            color:<?php echo jobcareer_special_char($cs_copyright_text_color); ?> <?php echo $importent_label; ?>;
            }
        <?php }if (isset($cs_link_color) && $cs_link_color != '') { ?>
            footer#footer a, .footer-nav li a, .cs-footer .widget ul li a:before  {
            color:<?php echo jobcareer_special_char($cs_link_color); ?> <?php echo $importent_label; ?>;
            }<?php
        }
        if (isset($cs_link_color) && $cs_link_color != '') {
            ?>
            .footer-nav li::before  {
            background-color:<?php echo jobcareer_special_char($cs_link_color); ?> <?php echo $importent_label; ?>;
            }<?php
        }

        if (isset($cs_copyright_text_color) && $cs_copyright_text_color != '') {
            ?>
            footer#footer .footer-links a.footer#footer .footer-link {color:<?php echo jobcareer_special_char($cs_copyright_text_color); ?> <?php echo $importent_label; ?>;}
            <?php
        }
