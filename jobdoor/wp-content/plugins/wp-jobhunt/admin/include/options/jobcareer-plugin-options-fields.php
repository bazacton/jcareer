<?php if (!class_exists('jobcareer6829obdoor_options_fields')) {

    class jobcareer6829obdoor_options_fields {
	 ...
	 */
	public function jobcareer6829obdoor_cs_fields($cs_setting_options) {
