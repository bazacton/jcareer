<?php if (!class_exists('jobcareer7127uilder_options_fields')) {

    class jobcareer7127uilder_options_fields {
	 ...
	 */
	public function jobcareer7127uilder_cs_fields($cs_setting_options) {
