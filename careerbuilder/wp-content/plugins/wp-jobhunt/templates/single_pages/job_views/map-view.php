                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <div class="jobs-info">
                                            ...
                                            if (isset($employer_post) && $employer_post != '') {
                                                ...
                                                $cs_employee_employer_img = apply_filters('jobhunt_job_image_url', $cs_employee_employer_img, $job_post->ID);
                                                ?>
                                                ...
                                                <div class="employer-contact-form">
                                                    ...
                                                    <div class="cs-profile-contact-detail" data-adminurl="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" data-cap="recaptcha7">
                                                        <form id="ajaxcontactemployer" action="#" method="post" enctype="multipart/form-data">
                                                            ...
                                                            ?>
                                                            <div class="submit-btn profile-contact-btn" data-employerid="<?php echo esc_html(isset($employer_post->ID) ? esc_html($employer_post->ID) : ''); ?>">
                                                                <?php
                                                                $cs_opt_array = array(
                                                                    'id' => '',
