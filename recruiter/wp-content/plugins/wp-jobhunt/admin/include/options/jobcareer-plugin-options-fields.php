<?php if (!class_exists('jobcareer7023ruiter_options_fields')) {

    class jobcareer7023ruiter_options_fields {
	 ...
	 */
	public function jobcareer7023ruiter_cs_fields($cs_setting_options) {
