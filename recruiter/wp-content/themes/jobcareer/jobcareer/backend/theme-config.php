...
if (!defined('DEFAULT_THEME_NAME')) {
    define('DEFAULT_THEME_NAME' , 'jobcareer');
}
...
if (!function_exists('get_demo_data_structure')) {
    ...
    function get_demo_data_structure()
    {
        $demo_data_structure = array(
            ...
            'elementor' => array(
                'slug' => 'elementor' ,
                'name' => esc_html__('Elementor' , 'jobcareer') ,
                'image_url' => 'http://chimpgroup.com/wp-demo/webservice/demo_images/jobcareer/jobcareer.jpg' ,
            ) ,
        );
...
if (!function_exists('get_server_requirements')) {
    ...
    function get_server_requirements()
    {
        ...
        $server_requirements['requirements'] = array(
            array(
                'title' => esc_html__('Min. php Version' , 'jobcareer') . ' = ' . $recommended_php_version . ' ( ' . esc_html__('Available' , 'jobcareer') . ' ' . phpversion() . ' )' ,
                'description' => esc_html__('To run this theme properly, mentioned min. PHP version is required.' , 'jobcareer') ,
                'version' => '' ,
            ...
            array(
                ...
                'description' => esc_html__('This sets the max. memory that a script is allowed to allocate.' , 'jobcareer') ,
                'version' => '' ,
                'is_met' => ($recommended_memory_limit <= $memory_limit) ,
            ) ,
            array(
                'title' => 'allow_url_fopen ' . esc_html__('should be enabled in' , 'jobcareer') . ' php.ini' ,
                'description' => esc_html__('This allows php to retrieve data remotely.' , 'jobcareer') ,
                'version' => '' ,
            ...
            array(
                ...
                'description' => esc_html__('This sets the max. input time that a script is allowed to allocate.' , 'jobcareer') ,
                'version' => '' ,
            ...
            array(
                ...
                'description' => esc_html__('This sets the max. execution time that a script is allowed to allocate.' , 'jobcareer') ,
                'version' => '' ,
            ...
            array(
                ...
                'description' => esc_html__('This sets the max. vars that a script is allowed to allocate.' , 'jobcareer') ,
                'version' => '' ,
                'is_met' => ($max_input_vars >= 5000) ,
            ) ,
            array(
                'title' => 'safe_mode = ' . $recommended_safe_mode . ' ( Available ' . $safe_mode . ' )' ,
                'description' => esc_html__('Ask hosting provider to disable safe mode.' , 'jobcareer') ,
                'version' => '' ,
        ...
        $server_requirements['extentions'] = array(
            array(
    ...
    function get_plugin_requirements()
    {
        ...
        $plugin_requirements = array(
            ...
            'job_hunt' => array(
                ...
                'description' => esc_html__('This core plugin is required to handles all jobcareer premium features.' , 'jobcareer') ,
            ...
            'rev_slider' => array(
                ...
                'description' => esc_html__('Its required to import sliders.' , 'jobcareer') ,
    ...
    function get_plugins_to_be_updated()
    {
        return array(
            ...
            array(
                ...
                'source' => trailingslashit(get_template_directory_uri()) . 'backend/theme-components/cs-activation-plugins/jobhunt-jobs-importer.zip' ,
                'required' => true ,
                'version' => '' ,
                'force_activation' => true ,
                'force_deactivation' => true ,
